...
//// Produce the point and angle values for the surface position from the given vector
...
//		sampleCount++;
//
//		// Determine whether this point is outside the set
//		externalPoint = SamplePoint(currentDistance, xFactor, yFactor, zFactor, c);
//	}
//
//	// Now search for the first point within the set
//	while (externalPoint && sampleCount < maxSamples)
//	{
//		// Move on to the next point
//		currentDistance += increment;
//		sampleCount++;
//
//		// Determine whether this point is within the set
//		externalPoint = SamplePoint(currentDistance, xFactor, yFactor, zFactor, c);
//
//		// If this is an internal point
//		if (!externalPoint)
//		{
//			// Perform binary search between this and the previous point, to determine surface position
//			currentDistance = FindSurface(increment, binarySearchSteps, currentDistance, xFactor, yFactor, zFactor);
//
//			// Test point a short distance further along, to determine whether this is still in the set
//			if (surfaceThickness > 0 && gapFound(currentDistance, surfaceThickness, xFactor, yFactor, zFactor, c))
//			{
//				// A gap was found between these points, so continue search
//				externalPoint = true;
//				continue;
//			}
//
